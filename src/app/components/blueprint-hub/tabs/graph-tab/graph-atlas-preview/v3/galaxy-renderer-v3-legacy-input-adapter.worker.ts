...
import { galaxyScenePacketV2TransferList, packGalaxyScenePacketV2 } from '../graph-galaxy-scene-packet-v2';
...
interface GalaxyRendererV3PacketRequest {
    id: number;
...
// Temporary one-way compatibility membrane: copied legacy inputs enter here;
// only an owned, transferred GalaxyScenePacketV2 can leave. V3 never receives
// a legacy scene object or shares the legacy compiler cache.
addEventListener('message', ({ data }: MessageEvent<GalaxyRendererV3PacketRequest>) => {
    try {
