    ...
    it('surfaces full atlas stage and projection timings in the last run panel model', async () => {
        ...
        expect(component.lastRunReceiptRows()).toEqual([
            ...
            expect.objectContaining({
                ...
                label: 'Transport Ops',
                durationMs: 30,
                detail: 'completed / 0 outputs / calls 3 / total 30 ms / max 15 ms / request 4.5 KiB / response 1.0 KiB / store 2 / wal calls 1 / wal request 2.0 KiB / compile calls 1 / compile request 2.5 KiB',
            }),
            expect.objectContaining({
                kind: 'stage',
                ...
                message: '3 embedding targets',
                    ...
                    },
                    {
                        ...
                        counters: {
                            ...
                            transportTotalMs: 30,
                            transportMaxMs: 15,
                            transportRequestBytes: 4608,
                            transportResponseBytes: 1024,
                            storeCommandCalls: 2,
