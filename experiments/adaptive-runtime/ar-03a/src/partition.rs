use adaptive_runtime_ar_02a_r2::TRAIN_SAMPLES;

pub const STRATUM_COUNT: usize = 12;
pub const STRATUM_SIZE: usize = 8;
pub const KMEANS_INIT_SEED: u64 = 0x4152_3033_414b_4d45;
pub const KMEANS_MAX_ITERATIONS: usize = 25;
const PLACEBO_SALT: u64 = 0x5232_504c_4143_4542;
...
mod tests {
    ...
    #[test]
    fn hash_placebos_have_exactly_twelve_groups_of_eight() {
        for id in 0..8 {
            let partition = hash_placebo(id);
            assert_eq!(stratum_counts(&partition), [8; STRATUM_COUNT]);
        }
        assert_ne!(hash_placebo(0), hash_placebo(1));
    }

    #[test]
    fn capacity_assignment_satisfies_all_group_quotas() {
        let distances = vec![0.0; TRAIN_SAMPLES * STRATUM_COUNT];
