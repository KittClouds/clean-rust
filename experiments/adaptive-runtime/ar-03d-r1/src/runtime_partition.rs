...
mod tests {
    ...
    fn projected_gradient_order_is_deterministic_and_balanced() {
        ...
        let model = Model::initial(protocol::INITIALIZATION_SEEDS[0]);
    ...
    fn verifier_panel_is_deterministic_unique_and_four_per_stratum() {
        ...
        let first = sample_panel(&ids, protocol::EVALUATION_SEEDS[0], 17);
        let second = sample_panel(&ids, protocol::EVALUATION_SEEDS[0], 17);
