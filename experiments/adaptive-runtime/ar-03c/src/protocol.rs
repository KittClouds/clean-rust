...
pub const CAPTURE_STEPS: [usize; 13] = [
    600, 601, 610, 625, 650, 700, 2_400, 2_401, 2_410, 2_425, 2_450, 2_500, 4_200,
];
pub const COMMITS_PER_EVIDENCE: usize = 4;
pub const ACTION_SCALE: f32 = 1.0;
pub const DATASET_SEEDS: [u64; 3] = [
    0xa303_dada_0000_0001,
    0xa303_dada_0000_0002,
    0xa303_dada_0000_0003,
];
pub const INITIALIZATION_SEEDS: [u64; 3] = [
    0xa303_1a17_0000_0001,
    0xa303_1a17_0000_0002,
    0xa303_1a17_0000_0003,
];
...
pub const DEVELOPMENT_SEEDS: [u64; 18] = [
    0xa303_de00_0000_0001,
    0xa303_de00_0000_0002,
    0xa303_de00_0000_0003,
    0xa303_de00_0000_0004,
    0xa303_de00_0000_0005,
    0xa303_de00_0000_0006,
    0xa303_de00_0000_0007,
    0xa303_de00_0000_0008,
    0xa303_de00_0000_0009,
    0xa303_de00_0000_000a,
    0xa303_de00_0000_000b,
    0xa303_de00_0000_000c,
    0xa303_de00_0000_000d,
    0xa303_de00_0000_000e,
    0xa303_de00_0000_000f,
    0xa303_de00_0000_0010,
    0xa303_de00_0000_0011,
    0xa303_de00_0000_0012,
];

pub const EVALUATION_SEEDS: [u64; 18] = [
    0xa303_ea00_0000_0001,
    0xa303_ea00_0000_0002,
    0xa303_ea00_0000_0003,
    0xa303_ea00_0000_0004,
    0xa303_ea00_0000_0005,
    0xa303_ea00_0000_0006,
    0xa303_ea00_0000_0007,
    0xa303_ea00_0000_0008,
    0xa303_ea00_0000_0009,
    0xa303_ea00_0000_000a,
    0xa303_ea00_0000_000b,
    0xa303_ea00_0000_000c,
    0xa303_ea00_0000_000d,
    0xa303_ea00_0000_000e,
    0xa303_ea00_0000_000f,
    0xa303_ea00_0000_0010,
    0xa303_ea00_0000_0011,
    0xa303_ea00_0000_0012,
];
...
pub fn collect_states(
    ...
    let first_seed = usize::from(dataset_index) * 3 + usize::from(initialization_index);
...
pub fn replay_seed(
    ...
    let mut snapshots = Vec::with_capacity(CAPTURE_STEPS.len());
    for evidence_round in 0..CAPTURE_STEPS[CAPTURE_STEPS.len() - 1] / COMMITS_PER_EVIDENCE {
        ...
        for inner in 0..COMMITS_PER_EVIDENCE {
            ...
            if CAPTURE_STEPS.contains(&step) {
    ...
    assert_eq!(snapshots.len(), CAPTURE_STEPS.len());
    snapshots
}
