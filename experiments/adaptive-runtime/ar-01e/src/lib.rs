...
pub enum Arm {
    ...
    E2SameFourCommits,
    E3SameEightCommits,
    E4IndependentOneCommit,
    E5IndependentTwoCommits,
    E6IndependentFourCommits,
    E7IndependentEightCommits,
    E8FullOneCommit,
    E9FullTwoCommits,
    E10FullFourCommits,
    E11FullEightCommits,
...
impl Arm {
    pub const ALL: [Self; 14] = [
        Self::E0SameOneCommit,
        Self::E1SameTwoCommits,
        Self::E2SameFourCommits,
        Self::E3SameEightCommits,
        Self::E4IndependentOneCommit,
        Self::E5IndependentTwoCommits,
        Self::E6IndependentFourCommits,
        Self::E7IndependentEightCommits,
        Self::E8FullOneCommit,
        Self::E9FullTwoCommits,
        Self::E10FullFourCommits,
        Self::E11FullEightCommits,
        Self::E12AdamW,
        Self::E13Sign,
    ];
    ...
    pub const fn label(self) -> &'static str {
        match self {
            Self::E0SameOneCommit => "E0-same-m1",
            Self::E1SameTwoCommits => "E1-same-m2",
            Self::E2SameFourCommits => "E2-same-m4",
            Self::E3SameEightCommits => "E3-same-m8",
            Self::E4IndependentOneCommit => "E4-independent-m1",
            Self::E5IndependentTwoCommits => "E5-independent-m2",
            Self::E6IndependentFourCommits => "E6-independent-m4",
            Self::E7IndependentEightCommits => "E7-independent-m8",
            Self::E8FullOneCommit => "E8-full-m1",
            Self::E9FullTwoCommits => "E9-full-m2",
            Self::E10FullFourCommits => "E10-full-m4",
            Self::E11FullEightCommits => "E11-full-m8",
            Self::E12AdamW => "E12-adamw",
            Self::E13Sign => "E13-sign",
        }
    }
    ...
    const fn beam(self) -> Option<usize> {
        match self {
            ...
            | Self::E9FullTwoCommits
            | Self::E10FullFourCommits
            | Self::E11FullEightCommits => Some(2),
            Self::E12AdamW | Self::E13Sign => None,
        }
    }
    ...
    const fn commits_per_evidence(self) -> usize {
        match self {
            Self::E0SameOneCommit | Self::E4IndependentOneCommit | Self::E8FullOneCommit => 1,
            Self::E1SameTwoCommits | Self::E5IndependentTwoCommits | Self::E9FullTwoCommits => 2,
            Self::E2SameFourCommits | Self::E6IndependentFourCommits | Self::E10FullFourCommits => {
                4
            }
            Self::E3SameEightCommits
            | Self::E7IndependentEightCommits
            | Self::E11FullEightCommits => 8,
            Self::E12AdamW | Self::E13Sign => 1,
        }
    }
    ...
    const fn verification(self) -> VerificationEvidence {
        match self {
            ...
            | Self::E1SameTwoCommits
            | Self::E2SameFourCommits
            | Self::E3SameEightCommits => VerificationEvidence::SameBatch,
            Self::E4IndependentOneCommit
            | Self::E5IndependentTwoCommits
            | Self::E6IndependentFourCommits
            | Self::E7IndependentEightCommits => VerificationEvidence::IndependentBatch,
            Self::E8FullOneCommit
            | Self::E9FullTwoCommits
            | Self::E10FullFourCommits
            | Self::E11FullEightCommits => VerificationEvidence::FullTrain,
            Self::E12AdamW | Self::E13Sign => VerificationEvidence::SameBatch,
        }
    }
...
pub fn run(samples: &[Sample], arm: Arm, seed: u64) -> RunSummary {
    ...
    for evidence_round in 0..arm.evidence_rounds() {
        ...
        } else if arm == Arm::E13Sign {
            let (_, gradient) = model.gradient(&proposal_storage);
            update_sign(&mut model, &gradient);
        } else {
            let independent_indices = batch_indices(seed, evidence_round, 0x5645_5249_4659_5354);
...
mod tests {
    ...
    fn short_runtime_run_commits_a_program() {
        let dataset = spiral_dataset();
        let result = run(&dataset.samples, Arm::E2SameFourCommits, SEEDS[0]);
