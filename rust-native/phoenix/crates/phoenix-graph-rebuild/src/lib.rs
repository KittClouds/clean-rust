...
pub use memory_governance::{
    ...
    MemoryGovernanceCompressionDominanceProof, MemoryGovernanceConfidenceSummary,
    MemoryGovernanceCounts, MemoryGovernanceEngineInput, MemoryGovernancePerformanceBudget,
    MemoryGovernanceRepresentativeRow, MemoryGovernanceRetrievalCandidate,
    ...
    MEMORY_GOVERNANCE_COMPRESSION_DOMINANCE_POLICY, MEMORY_GOVERNANCE_NO_TOPOLOGY_COMMIT,
    MEMORY_GOVERNANCE_PIN_PROTECTION_RATIONALE, MEMORY_GOVERNANCE_PIN_SOURCE_RATIONALE,
    MEMORY_GOVERNANCE_PIN_USER_OVERRIDE_PREFIX, MEMORY_GOVERNANCE_RETRIEVAL_PREVIEW_SCHEMA_VERSION,
